          ...
          {chapters.map((chapter) => (
            ...
            >
              <View style={styles.chapterCopy}>
                <Text style={[styles.rowTitle, { color: palette.text }]}>{chapter.titleEnglish || 'Untitled chapter'}</Text>
...
const styles = StyleSheet.create({
  ...
  row: { paddingVertical: 12, borderBottomWidth: 1, flexDirection: 'row', justifyContent: 'space-between', gap: 12 },
