  ...
  return (
    ...
    >
      ...
      <SectionCard
        title="Notifications"
        subtitle={
          capability === 'unsupported' ? 'Notifications are unavailable on this iOS device' : 'iOS reminders on this device'
        }
      >
        <View style={[styles.infoRow, { borderBottomColor: palette.border }]}>
          <View style={styles.infoCopy}>
            ...
            <Text style={[styles.infoBody, { color: palette.subtleText }]}>
              {capability === 'unsupported'
                ? 'This iOS device cannot schedule the local prayer reminders used by this app.'
                : 'iOS can schedule local prayer reminders with bundled sounds.'}
            </Text>
          </View>
          <Text style={[styles.infoValue, { color: palette.text }]}>
